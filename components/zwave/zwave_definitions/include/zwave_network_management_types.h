...
/**
 * @brief High-level activity of the Network Management module.
 *
 * Describes what kind of operation is in progress without exposing
 * internal state machine details.
 */
typedef enum {
    /// No operation is in progress.
    ZWAVE_NETWORK_MANAGEMENT_ACTIVITY_IDLE,
    /// An inclusion (add node) operation is in progress.
    ZWAVE_NETWORK_MANAGEMENT_ACTIVITY_INCLUSION_ONGOING,
    /// An exclusion (remove node) operation is in progress.
    ZWAVE_NETWORK_MANAGEMENT_ACTIVITY_EXCLUSION_ONGOING,
    /// A learn mode operation is in progress.
    ZWAVE_NETWORK_MANAGEMENT_ACTIVITY_LEARNING_ONGOING,
    /// An internal housekeeping operation is in progress.
    ZWAVE_NETWORK_MANAGEMENT_ACTIVITY_INTERNAL_ONGOING,
    /// An unknown operation is in progress.
    ZWAVE_NETWORK_MANAGEMENT_ACTIVITY_UNKNOWN,
} zwave_network_management_activity_t;
