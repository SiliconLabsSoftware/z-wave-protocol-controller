...
/**
 * @defgroup zpc_attribute_utils ZPC attribute utilities
 * @ingroup zpc_components
 * @brief ZPC @ref attribute_store utilities
 *
...
/**
 * @defgroup zpc_attribute_timeouts ZPC attribute timeouts
 * @ingroup zpc_attribute_utils
...
/**
 * @brief Initializes the ZPC attribute timeouts component
 *
...
/**
 * @brief Teardown the ZPC attribute timeouts component
