 ...
 * by monitoring Z-Wave NIF creations in the attribute store. An undefined NIF
 * created after a successful add means interviewing; security-failed adds do
 * not create that NIF placeholder and must not enter ONLINE_INTERVIEWING.
 *
 *  @startuml Network Monitor Interview monitoring
    ...
    deactivate NetworkMonitor
    ...
    note over NetworkMonitor: Interview fully resolved
