 ...
 */
typedef enum { FIRMWARE_UPDATE_NVM_INIT = 0, FIRMWARE_UPDATE_NVM_SET_NEW_IMAGE = 1, FIRMWARE_UPDATE_NVM_GET_NEW_IMAGE = 2, FIRMWARE_UPDATE_NVM_UPDATE_CRC16 = 3, FIRMWARE_UPDATE_NVM_IS_VALID_CRC16 = 4, FIRMWARE_UPDATE_NVM_WRITE = 5, FIRMWARE_UPDATE_NVM_UNKNOWN = 0xFF } FIRMWARE_UPDATE_NVM_T;
