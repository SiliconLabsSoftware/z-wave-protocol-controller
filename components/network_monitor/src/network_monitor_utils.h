...
namespace __private
{
     ...
     */
    template<class Sequence> void retain_recursive(Sequence &sequence, typename Sequence::iterator &begin, const typename Sequence::iterator &end, const std::function<bool(const typename Sequence::const_iterator &)> predicate)
    {
 ...
 * @param predicate function that defines the retain condition.
 */
template<class Sequence> static void retain(Sequence &sequence, const std::function<bool(const typename Sequence::const_iterator &)> predicate)
{
