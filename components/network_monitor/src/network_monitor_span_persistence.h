...
package "Attribute Store" <<Database>> {
  ...
  package "Other Nodes"{
    ...
    object "Network Monitor Group" as nm_group #e6f0ff
    nm_group : Attribute Type = NETWORK_MONITOR_GROUP

    object "SPAN Entry" as span_entry #FEFEFE
    span_entry : Attribute Type = s2_span_entry
...
package "Attribute Store" <<Database>> {
  ...
  object "Network Monitor Group" as zpc_nm_group #e6f0ff
  zpc_nm_group : Attribute Type = NETWORK_MONITOR_GROUP

  object "ZPC MPAN table" as mpan_table #FEFEFE
  mpan_table : Attribute Type = s2_mpan_table
  mpan_table : value = Desired: [], Reported: []

  object "ZPC MPAN entry 1" as mpan_entry_1 #FEFEFE
  mpan_entry_1 : Attribute Type = s2_mpan_entry
  ...
  mpan_entry_2 : Attribute Type = s2_mpan_entry
  ...
  package "Other Nodes"{
    ...
    object "Network Monitor Group" as node_nm_group #e6f0ff
    node_nm_group : Attribute Type = NETWORK_MONITOR_GROUP

    object "Multicast Group list" as multicast_group_list #FEFEFE
    multicast_group_list : Attribute Type = multicast_group_list
    multicast_group_list : value = Desired: [], Reported: []

    object "Multicast Group" as multicast_group_1 #FEFEFE
    multicast_group_1 : Attribute Type = multicast_group
    multicast_group_1 : value = Desired: [], Reported: [01]

    object "Multicast Group" as multicast_group_2 #FEFEFE
    multicast_group_2 : Attribute Type = multicast_group
...
zpc_node *-- zpc_nm_group
zpc_nm_group *-- mpan_table
mpan_table *-- mpan_entry_1
mpan_table *-- mpan_entry_2

home_id *-- node
node *-- node_nm_group
node_nm_group *-- multicast_group_list
