...
class zwave_tx_groups
{
    private:
         ...
         */
        static sl_status_t analyze_group_suitability(const zwave_nodemask_t list, const zwave_nodemask_t group_nodes, uint16_t *common_nodes);
        /**
         ...
         */
        static bool is_node_list_empty(const zwave_nodemask_t nodes);
