...
/**
 * @defgroup zwave_controller_transport Z-Wave Controller Transport Framework
...
typedef struct zwave_controller_transport {
        ...
        /**
         * @brief abort function that instructs the transport to abort one or more
         *        ongoing transmission(s)
         *
         * Functions registered for abort send data must use the following return
         * statuses
        ...
        /**
         * @brief Optional query: is this transport currently busy with a
         * send operation it cannot pre-empt?
         *
         * Registering this callback is optional; if the pointer is NULL the
         * transport is treated as never busy.
         *
         * @return true  if the transport is busy.
         * @return false if the transport is idle.
         */
        bool (*is_busy)(void);
        /* data */
