...
#define ATTRIBUTE_STORE_INVALID_ATTRIBUTE_TYPE ((attribute_store_type_t)0x0000)  ///< This represents an invalid attribute Type. Shall not be used for nodes in the attribute store.

#define ATTRIBUTE_TREE_ROOT ((attribute_store_type_t)0x0001)  ///< This represents the root of the attribute store tree.
...
static inline attribute_store_node_t attribute_store_get_first_child_by_type(attribute_store_node_t node, attribute_store_type_t child_type)
{
