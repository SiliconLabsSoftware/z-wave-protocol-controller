...
#define DATASTORE_TABLE_INT "zpc_kv_int"
/// Table for storing arrays
#define DATASTORE_TABLE_BLOB "zpc_kv_blob"
/// Table for storing the attribute store
#define DATASTORE_TABLE_ATTRIBUTES "zpc_attributes"
/// Legacy table for storing integers
#define LEGACY_DATASTORE_TABLE_INT "uic_kv_int"
/// Legacy table for storing arrays
#define LEGACY_DATASTORE_TABLE_BLOB "uic_kv_blob"
/// Legacy table for storing the attribute store
#define LEGACY_DATASTORE_TABLE_ATTRIBUTES "uic_attributes"
