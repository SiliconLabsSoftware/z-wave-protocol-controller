...
class Const:
    ...
    @classmethod
    def from_xml_element(cls, element: Element, version_tracker: XMLElementVersionTracker, cc_name: str, command_name: str, param_name: str, cc_version: int) -> 'Const':
        name = element.attrib.get("flagname", "UNDEFINED_CONST_NAME")
