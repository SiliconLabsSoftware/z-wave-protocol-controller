...
/**
 * @defgroup transport_service_transport_wrapper Transport Service Transport Wrapper
 * @ingroup zwave_transports
 * @brief Wrapper for the Transport Service Command Class Transport
 *
 * @{
 */
...
/** @} end transport_service_transport_wrapper*/
