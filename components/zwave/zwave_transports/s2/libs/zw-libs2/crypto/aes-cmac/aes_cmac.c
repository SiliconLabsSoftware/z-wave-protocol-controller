...
void aes_cmac_calculate(const uint8_t *key, const uint8_t *message, const uint16_t message_length, uint8_t *mac)
{
    uint8_t X[16];
    uint8_t Y[16];
    uint8_t M_last[16];
...
CMAC_VERIFY_T aes_cmac_verify(const uint8_t *key, const uint8_t *message, const uint16_t message_length, const uint8_t *mac)
{
