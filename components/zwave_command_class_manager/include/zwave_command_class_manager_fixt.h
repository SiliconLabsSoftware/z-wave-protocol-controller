...
#ifndef ZWAVE_COMMAND_CLASSES_MANAGER_FIXT_H
#define ZWAVE_COMMAND_CLASSES_MANAGER_FIXT_H
 ...
 * @brief Initializations for Command Classes manager
 *
 * The Command Classes fixtures provides a list of initialization functions allowing
 * to initialize Z-Wave Command manager.
 *
 * @{
 */
...
#endif  // ZWAVE_COMMAND_CLASSES_MANAGER_FIXT_H
