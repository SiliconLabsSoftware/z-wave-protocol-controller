...
Protocol (Z-Wave), Protocol Long Range, Security 0 (S0), Security 2 (S2), and Transport Service are not generated by the command class generator; they are implemented manually. S0, S2, and Transport Service are handled by the transport layer and are not exposed at the application layer.
