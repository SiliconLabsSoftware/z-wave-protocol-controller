...
#ifndef OTA_STEP_FAILED_HPP
#define OTA_STEP_FAILED_HPP
...
namespace ota
{
    ...
    /**
     * @brief Unrecoverable failure; clears session when entered.
     */
    class OtaStepFailed : public OtaStep
    {
        public:
            OtaStepFailed() = default;
