...
extern "C" {
#endif
typedef enum { S0_INC_IDLE, S0_AWAITING_SCHEME_REPORT, S0_HANDLE_SCHEME_REPORT, S0_AWAITING_KEY_VERIFY, S0_HANDLE_NET_KEY_VERIFY, S0_AWAITING_2SCHEME_REPORT } s0_bootstrap_state_t;
