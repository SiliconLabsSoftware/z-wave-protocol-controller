 ...
 */
void on_resolver_send_data_complete(resolver_send_status_t status, clock_time_t transmission_time, attribute_store_node_t node, resolver_rule_type_t rule_type);
