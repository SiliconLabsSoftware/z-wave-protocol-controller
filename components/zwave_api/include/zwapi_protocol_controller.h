...
typedef struct zwapi_node_info_header {
        ...
        uint8_t reserved;
        node_type_t node_type;  ///< Basic, Generic and Specific Device types - Basic is generated...
 ...
 */
sl_status_t zwapi_request_network_update(void (*complFunc)(uint8_t txStatus));
 ...
 */
sl_status_t zwapi_set_virtual_node_to_learn_mode(zwave_node_id_t node, uint8_t mode, void (*completedFunc)(uint8_t bStatus, zwave_node_id_t orgID, zwave_node_id_t newID));
