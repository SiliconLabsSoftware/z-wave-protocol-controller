...
#ifndef COMMAND_CLASS_PROTOCOL_CORE_H
#define COMMAND_CLASS_PROTOCOL_CORE_H
...
namespace zwave_command_class
{
    ...
    class command_class_protocol_core : public zwave_command_class_base
    {
        public:
            // Constructor
            command_class_protocol_core();
            ~command_class_protocol_core() = default;
...
#endif  // COMMAND_CLASS_PROTOCOL_CORE_H
