...
bool ZW_TransportService_SendData(ts_param_t *p, const uint8_t *pData, uint16_t dataLength, void (*completedFunc)(uint8_t txStatus, void *));
#else
bool ZW_TransportService_SendData(ts_param_t *p, uint8_t *pData, uint16_t dataLength, void (*completedFunc)(uint8_t txStatus, void *));
#endif
 ...
 *
 */
void ZW_TransportService_Init(void (*commandHandler)(ts_param_t *p, ZW_APPLICATION_TX_BUFFER *pCmd, uint16_t cmdLength));
