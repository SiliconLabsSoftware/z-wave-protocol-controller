...
DEFINE_ATTRIBUTE(
  ATTRIBUTE_COMMAND_CLASS_HUMIDITY_CONTROL_SETPOINT_SUPPORTED_SCALE,
...
DEFINE_ATTRIBUTE(
  ATTRIBUTE_COMMAND_CLASS_HUMIDITY_CONTROL_SETPOINT_MIN_VALUE_SCALE,
  ((COMMAND_CLASS_HUMIDITY_CONTROL_SETPOINT << 8) | 0x09))
DEFINE_ATTRIBUTE(
  ATTRIBUTE_COMMAND_CLASS_HUMIDITY_CONTROL_SETPOINT_MIN_VALUE_PRECISION,
...
DEFINE_ATTRIBUTE(
  ATTRIBUTE_COMMAND_CLASS_HUMIDITY_CONTROL_SETPOINT_MAX_VALUE_SCALE,
  ((COMMAND_CLASS_HUMIDITY_CONTROL_SETPOINT << 8) | 0x0C))
DEFINE_ATTRIBUTE(
  ATTRIBUTE_COMMAND_CLASS_HUMIDITY_CONTROL_SETPOINT_MAX_VALUE_PRECISION,
...
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_VALUE_SCALE,
                 ((COMMAND_CLASS_THERMOSTAT_SETPOINT << 8)
                  | (0x04 + SETPOINT_SCALE_ATTRIBUTE_ID_OFFSET)))
// 0x06
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_VALUE_PRECISION,
                 ((COMMAND_CLASS_THERMOSTAT_SETPOINT << 8)
                  | (0x04 + SETPOINT_PRECISION_ATTRIBUTE_ID_OFFSET)))
...
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_MIN_VALUE_SCALE,
                 ((COMMAND_CLASS_THERMOSTAT_SETPOINT << 8)
                  | (0x07 + SETPOINT_SCALE_ATTRIBUTE_ID_OFFSET)))
// 0x09
DEFINE_ATTRIBUTE(
  ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_MIN_VALUE_PRECISION,
  ((COMMAND_CLASS_THERMOSTAT_SETPOINT << 8)
   | (0x07 + SETPOINT_PRECISION_ATTRIBUTE_ID_OFFSET)))
...
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_MAX_VALUE_SCALE,
                 ((COMMAND_CLASS_THERMOSTAT_SETPOINT << 8)
                  | (0x0A + SETPOINT_SCALE_ATTRIBUTE_ID_OFFSET)))
// 0x0C
DEFINE_ATTRIBUTE(
  ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_MAX_VALUE_PRECISION,
  ((COMMAND_CLASS_THERMOSTAT_SETPOINT << 8)
   | (0x0A + SETPOINT_PRECISION_ATTRIBUTE_ID_OFFSET)))

DEFINE_ATTRIBUTE(
  ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_USE_B_INTERPRETATION,
