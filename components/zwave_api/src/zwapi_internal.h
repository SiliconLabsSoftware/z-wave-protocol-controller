...
extern void (*zwapi_set_virtual_node_to_learn_mode_callback)(uint8_t bStatus, zwave_node_id_t orgID, zwave_node_id_t newID);
...
#define ZW_COMMAND_RETURN_VALUE_FALSE 0  ///< Command was not executed without errors
