...
typedef enum {
    /// No S2 user response is expected
    NM_S2_USER_INPUT_NONE,
    /// Waiting for GrantKeys response from user
    NM_S2_USER_INPUT_GRANT_KEYS,
    /// Waiting for DSK/Accept response from user
    NM_S2_USER_INPUT_ACCEPT_DSK,
} nm_s2_user_input_t;
