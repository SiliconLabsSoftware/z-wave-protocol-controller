...
The EED emulates a single or set of end devices as if controlled by a protocol controller. This is solely for better develop experience and is a experimental implementation.
