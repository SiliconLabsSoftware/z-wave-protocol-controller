...
/**
 * @defgroup zwave_s2_keystore_internals Z-Wave S2 Keystore internals
 * @ingroup zwave_s2_transport
 * @brief Internal functions for the S2 Keystore
 *
 * @{
 */
...
#define nvm_config_get(par_name, dst) zwapi_memory_get_buffer(offsetof(struct nvm_config, par_name), (uint8_t *)dst, sizeof(((struct nvm_config *)0)->par_name))
#define nvm_config_set(par_name, src) zwapi_memory_put_buffer(offsetof(struct nvm_config, par_name), (uint8_t *)src, sizeof(((struct nvm_config *)0)->par_name), NULL)
