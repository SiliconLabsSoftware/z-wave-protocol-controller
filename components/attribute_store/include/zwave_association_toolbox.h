...
/**
 * @defgroup zwave_association_toolbox Z-Wave Association toolbox
 * @brief Helper defintions and functions to manipulate association data in the attribute store
 *
 * Helper defintions and functions to manipulate association data in the attribute store
 *
 * @{
 */

#ifndef ZWAVE_ASSOCIATION_TOOLBOX_H
#define ZWAVE_ASSOCIATION_TOOLBOX_H
...
/**
 * @addtogroup zpc_attribute_store_command_classes_types
 * @{
 */
...
#endif  // ZWAVE_ASSOCIATION_TOOLBOX_H
