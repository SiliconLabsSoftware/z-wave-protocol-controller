...
void test_cmac_ietf_rfc4493_test_vectors_example_1(void)
{
  ...
  const uint8_t expaected_mac[] = {0xbb,
                                   0x1d,
                                   0x69,
                                   0x29,
                                   0xe9,
  ...
  UNITY_TEST_ASSERT_EQUAL_UINT8_ARRAY(expaected_mac,
                                      calculated_mac,
                                      16,
                                      __LINE__,
                                      "");
...
void test_cmac_ietf_rfc4493_test_vectors_example_2(void)
{
  ...
  const uint8_t message[] = {0x6b,
                             ...
                             0x2a};
  uint8_t calculated_mac[16];
  const uint8_t expected_mac[] = {0x07,
                                  0x0a,
                                  0x16,
                                  0xb4,
                                  0x6b,
  ...
  UNITY_TEST_ASSERT_EQUAL_UINT8_ARRAY(expected_mac,
                                      calculated_mac,
                                      16,
                                      __LINE__,
                                      "");
...
void test_cmac_ietf_rfc4493_test_vectors_example_3(void)
{
  ...
  uint8_t calculated_mac[16];
  const uint8_t expected_mac[] = {0xdf,
                                  0xa6,
                                  0x67,
                                  0x47,
                                  0xde,
...
void test_cmac_ietf_rfc4493_test_vectors_example_4(void)
{
  ...
  uint8_t calculated_mac[16];
  const uint8_t expected_mac[] = {0x51,
                                  0xf0,
                                  0xbe,
                                  0xbf,
                                  0x7e,
...
void test_cmac_xor_120(void)
{
  ...
  UNITY_TEST_ASSERT_EQUAL_UINT8_ARRAY(expected,
                                      output,
                                      sizeof(expected),
                                      __LINE__,
                                      "");
