...
#define NAK \
  0x15  ///< Not Acknowledge successful frame reception - please retransmit...
...
typedef enum {
  ...
  = 2,  ///< 2 bytes for the legacy NVM backup & restore command
  NVM_EXT_BACKUP_RESTORE_ADDR_SIZE
  = 4,  ///< 4 bytes for the extended NVM backup & restore command
