...
/**
 * @defgroup zpc_components ZPC components
 * @brief Shared ZPC component library groups.
 */

/**
 * @defgroup zpc_definitions ZPC definitions
 * @ingroup zpc_components
 * @brief Type definitions and macros for ZPC components and applications.
 */

/**
 * @defgroup zpc_sl_status_codes Status Codes
 * @ingroup zpc_definitions
