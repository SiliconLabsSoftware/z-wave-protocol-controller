...
sl_status_t zwapi_request_neighbor_update(zwave_node_id_t bNodeID, void (*completedFunc)(uint8_t))
{
    ...
    return zwapi_send_command(FUNC_ID_ZW_REQUEST_NODE_NEIGHBOR_UPDATE, request_buffer, index);
}
...
sl_status_t zwapi_get_protocol_info(zwave_node_id_t bNodeID, zwapi_node_info_header_t *node_info_header)
{
    ...
    zwapi_write_node_id(request_buffer, &index, bNodeID);
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_GET_NODE_PROTOCOL_INFO, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_get_virtual_nodes(zwave_nodemask_t node_mask)
{
    uint8_t response_length                   = 0;
    uint8_t response_buffer[FRAME_LENGTH_MAX] = {0};
    sl_status_t send_command_status           = zwapi_send_command_with_response(FUNC_ID_ZW_GET_VIRTUAL_NODES, NULL, 0, response_buffer, &response_length);

    if (send_command_status == SL_STATUS_OK && response_length >= (IDX_DATA + ZW_MAX_NODEMASK_LENGTH)) {
...
sl_status_t zwapi_set_default(void (*completedFunc)(void)) /* IN Command completed call back function */
{
    uint8_t func_id;
    uint8_t index                               = 0;
    uint8_t request_buffer[REQUEST_BUFFER_SIZE] = {0};
...
sl_status_t zwapi_transfer_primary_ctrl_role(uint8_t bMode, void (*completedFunc)(LEARN_INFO *))
{
    ...
    return zwapi_send_command(FUNC_ID_ZW_CONTROLLER_CHANGE, request_buffer, index);
}
...
sl_status_t zwapi_add_node_to_network(uint8_t bMode, void (*completedFunc)(LEARN_INFO *))
{
    ...
    return zwapi_send_command(FUNC_ID_ZW_ADD_NODE_TO_NETWORK, request_buffer, index);
}
...
sl_status_t zwapi_remove_node_from_network(uint8_t bMode, void (*completedFunc)(LEARN_INFO *))
{
    ...
    return zwapi_send_command(FUNC_ID_ZW_REMOVE_NODE_FROM_NETWORK, request_buffer, index);
}
...
uint8_t zwapi_remove_failed_node(zwave_node_id_t NodeID, void (*completedFunc)(uint8_t))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_REMOVE_FAILED_NODE_ID, request_buffer, index, response_buffer, &response_length);
...
uint8_t zwapi_replace_failed_node(zwave_node_id_t NodeID, bool bNormalPower, void (*completedFunc)(uint8_t txStatus))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_REPLACE_FAILED_NODE, request_buffer, index, response_buffer, &response_length);
    if (send_command_status == SL_STATUS_OK && response_length > IDX_DATA) {
        return response_buffer[IDX_DATA];
    }
...
sl_status_t zwapi_assign_return_route(zwave_node_id_t bSrcNodeID, zwave_node_id_t bDstNodeID, void (*completedFunc)(uint8_t bStatus))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_ASSIGN_RETURN_ROUTE, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_delete_return_route(zwave_node_id_t nodeID, void (*completedFunc)(uint8_t))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_DELETE_RETURN_ROUTE, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_assign_suc_return_route(zwave_node_id_t bSrcNodeID, void (*completedFunc)(uint8_t))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_ASSIGN_SUC_RETURN_ROUTE, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_delete_suc_return_route(zwave_node_id_t nodeID, void (*completedFunc)(uint8_t))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_DELETE_SUC_RETURN_ROUTE, request_buffer, index, response_buffer, &response_length);
...
zwave_node_id_t zwapi_get_suc_node_id(void)
{
    ...
    sl_status_t send_command_status           = zwapi_send_command_with_response(FUNC_ID_ZW_GET_SUC_NODE_ID, NULL, 0, response_buffer, &response_length);

    if (send_command_status == SL_STATUS_OK && (((NODEID_8BITS == zwapi_get_node_id_basetype()) && (response_length > IDX_DATA)) || ((NODEID_16BITS == zwapi_get_node_id_basetype()) && (response_length > IDX_DATA + 1)))) {
...
sl_status_t zwapi_set_suc_node_id(zwave_node_id_t nodeID, uint8_t SUCState, uint8_t bTxOption, uint8_t bCapabilities, void (*completedFunc)(uint8_t txStatus))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_SET_SUC_NODE_ID, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_set_learn_mode(uint8_t mode, void (*completedFunc)(LEARN_INFO *))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_SET_LEARN_MODE, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_set_virtual_node_to_learn_mode(zwave_node_id_t node, uint8_t mode, void (*completedFunc)(uint8_t, zwave_node_id_t, zwave_node_id_t))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_SET_SLAVE_LEARN_MODE, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_request_node_info(zwave_node_id_t node_id)
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_REQUEST_NODE_INFO, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_request_protocol_cc_encryption_callback(uint8_t tx_status, const zwapi_tx_report_t *tx_report, uint8_t session_id)
{
    ...
    sl_status_t send_command_status = zwapi_send_command(FUNC_ID_ZW_REQUEST_PROTOCOL_CC_ENCRYPTION, request_buffer, index);
...
sl_status_t zwapi_send_controller_replication(zwave_node_id_t nodeID, const uint8_t *pData, uint8_t dataLength, uint8_t txOptions, void (*completedFunc)(uint8_t txStatus))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_REPLICATION_SEND_DATA, request_buffer, index, response_buffer, &response_length);
...
uint8_t zwapi_get_controller_capabilities(void)
{
    uint8_t response_length                   = 0;
    uint8_t response_buffer[FRAME_LENGTH_MAX] = {0};
    sl_status_t send_command_status           = zwapi_send_command_with_response(FUNC_ID_ZW_GET_CONTROLLER_CAPABILITIES, NULL, 0, response_buffer, &response_length);
...
sl_status_t zwapi_request_network_update(void (*complFunc)(uint8_t))
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_REQUEST_NETWORK_UPDATE, request_buffer, index, response_buffer, &response_length);
...
bool zwapi_is_node_failed(zwave_node_id_t nodeID)
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_IS_FAILED_NODE_ID, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_set_max_source_route(uint8_t maxRouteTries)
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_SET_ROUTING_MAX, request_buffer, index, response_buffer, &response_length);
...
uint8_t zwapi_get_priority_route(zwave_node_id_t bNodeID, uint8_t *pLastWorkingRoute)
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_GET_LAST_WORKING_ROUTE, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_set_priority_route(zwave_node_id_t bNodeID, const uint8_t *pLastWorkingRoute)
{
    uint8_t response_length                     = 0;
    uint8_t index                               = 0;
    uint8_t request_buffer[REQUEST_BUFFER_SIZE] = {0};
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_SET_LAST_WORKING_ROUTE, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_get_old_routing_info(zwave_node_id_t bNodeID, uint8_t *buf, uint8_t bRemoveBad, uint8_t bRemoveNonReps)
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_GET_ROUTING_TABLE_LINE, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_enable_suc(uint8_t state, uint8_t capabilities)
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_ENABLE_SUC, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_set_virtual_node_application_node_information(zwave_node_id_t dstNode, uint8_t listening, const node_type_t *node_type, const uint8_t *nodeParm, uint8_t parmLength)
{
    uint8_t index                               = 0;
    uint8_t request_buffer[REQUEST_BUFFER_SIZE] = {0};
    ...
    return zwapi_send_command(FUNC_ID_ZW_SET_SLAVE_LEARN_MODE, request_buffer, index);
}
...
sl_status_t zwapi_enable_node_nls(const zwave_node_id_t nodeId)
{
    ...
    uint8_t response_buffer[FRAME_LENGTH_MAX]   = {0};
    zwapi_write_node_id(request_buffer, &index, nodeId);
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_ENABLE_NODE_NLS, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_get_node_nls(const zwave_node_id_t nodeId, uint8_t *nls_state, uint8_t *nls_support)
{
    ...
    uint8_t response_buffer[FRAME_LENGTH_MAX]   = {0};
    zwapi_write_node_id(request_buffer, &index, nodeId);
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_GET_NODE_NLS_STATE, request_buffer, index, response_buffer, &response_length);
...
sl_status_t zwapi_get_nls_nodes(uint16_t *list_length, zwave_nodemask_t node_list)
{
    ...
    *list_length               = 0;
    ...
    while (more_nodes > 0) {
        ...
        command_status = zwapi_send_command_with_response(FUNC_ID_ZW_GET_NLS_NODES, request_buffer, index, response_buffer, &response_length);
            ...
            *list_length += received_nodelist_length;
            ...
            for (uint8_t i = 0; i < received_nodelist_length; i++) {
                if ((i + (start_offset * GET_NLS_NODES_OFFSET_GRANULARITY_IN_BYTES))  // NOSONAR
                    ...
                    sl_log_debug(LOG_TAG, "Z-Wave API get NLS node list index of bound\n");
                    return SL_STATUS_FAIL;
                }
                node_list[i + (start_offset * GET_NLS_NODES_OFFSET_GRANULARITY_IN_BYTES)] = *p;
                p++;
            }
            start_offset++;
        } else {
            sl_log_debug(LOG_TAG, "Z-Wave API get NLS node list retrieve error, %d", command_status);
            return SL_STATUS_FAIL;
        }
    }
    ...
    memmove(&node_list[ZW_LR_NODEMASK_OFFSET - 1], &node_list[ZW_MAX_NODEMASK_LENGTH - 1], ZW_LR_MAX_NODEMASK_LENGTH - ZW_LR_NODEMASK_OFFSET);
...
sl_status_t zwapi_transfer_protocol_cc(const zwave_node_id_t srcNode, const uint8_t decryptionKey, const uint8_t payloadLength, const uint8_t *const payload)
{
    ...
    sl_status_t send_command_status = zwapi_send_command_with_response(FUNC_ID_ZW_TRANSFER_PROTOCOL_CC, request_buffer, index, response_buffer, &response_length);
