...
void test_zwave_smartstart_inclusion_all_dsk_already_in_network()
{
  ...
  TEST_ASSERT_EQUAL(find_dsk_obfuscated_bytes_from_smart_start_list(dsk, 2),
                    true);
  TEST_ASSERT_EQUAL_CHAR(dsk[0], 0x2B);
  TEST_ASSERT_EQUAL_CHAR(dsk[1], 0x99);
  // Garbled DS                    VV
  zwave_dsk_t gdsk = {0x00,
                      0x00,
                      0x00,
                      0xC4,
                      0x70,
                      ...
                      0x0F,
                      0x50};
  TEST_ASSERT_EQUAL(find_dsk_obfuscated_bytes_from_smart_start_list(gdsk, 2),
                    false);
