...
class ZwaveCommandClassType
{
    public:
         ...
         * @return type_t
         */
        static inline type_t get_type(zwave_command_class_t command_class, zwave_command_t command)
        {
         ...
         * @return false
         */
        static inline bool is_supporting(zwave_command_class_t command_class, zwave_command_t command)
        {
            uint16_t key = (command_class << 8) | command;
