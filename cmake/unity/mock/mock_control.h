...
#define MOCK_CALL_COMPARE_INPUT_UINT8(P_MOCK, ARGUMENT, RECV_VALUE) MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, UINT8)

#define MOCK_CALL_COMPARE_INPUT_UINT16(P_MOCK, ARGUMENT, RECV_VALUE) MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, UINT16)

#define MOCK_CALL_COMPARE_INPUT_UINT32(P_MOCK, ARGUMENT, RECV_VALUE) MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, UINT32)

#define MOCK_CALL_COMPARE_INPUT_INT8(P_MOCK, ARGUMENT, RECV_VALUE) MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, INT8)

#define MOCK_CALL_COMPARE_INPUT_INT32(P_MOCK, ARGUMENT, RECV_VALUE) MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, INT32)

#define MOCK_CALL_COMPARE_INPUT_HEX64(P_MOCK, ARGUMENT, RECV_VALUE) MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, HEX64)

#define MOCK_CALL_COMPARE_INPUT_HEX32(P_MOCK, ARGUMENT, RECV_VALUE) MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, HEX32)

#define MOCK_CALL_COMPARE_INPUT_HEX16(P_MOCK, ARGUMENT, RECV_VALUE) MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, HEX16)

#define MOCK_CALL_COMPARE_INPUT_HEX8(P_MOCK, ARGUMENT, RECV_VALUE) MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, HEX8)

#define MOCK_CALL_COMPARE_INPUT_HEX_ARRAY(P_MOCK, ARGUMENT, RECV_VALUE) MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, HEX_ARRAY)

#define MOCK_CALL_COMPARE_INPUT(P_MOCK, ARGUMENT, RECV_VALUE, TYPE)                                                                                                                                                      \
    do {                                                                                                                                                                                                                 \
        char __str[4096];                                                                                                                                                                                                \
...
#define MOCK_CALL_COMPARE_INPUT_BOOL(P_MOCK, ARGUMENT, RECV_VALUE)                                                                                                                                                       \
    do {                                                                                                                                                                                                                 \
        char __str[4096];                                                                                                                                                                                                \
        switch (P_MOCK->compare_rule_arg[ARGUMENT]) {                                                                                                                                                                    \
            case COMPARE_STRICT:                                                                                                                                                                                         \
...
#define MOCK_CALL_COMPARE_STRUCT_MEMBER_UINT8(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, MEMBER) MOCK_CALL_COMPARE_STRUCT_MEMBER(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, MEMBER, UINT8)

#define MOCK_CALL_COMPARE_STRUCT_MEMBER_UINT16(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, MEMBER) MOCK_CALL_COMPARE_STRUCT_MEMBER(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, MEMBER, UINT16)

#define MOCK_CALL_COMPARE_STRUCT_MEMBER_UINT32(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, MEMBER) MOCK_CALL_COMPARE_STRUCT_MEMBER(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, MEMBER, UINT32)

#define MOCK_CALL_COMPARE_STRUCT_MEMBER(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, MEMBER, TYPE)                                                                                                                                               \
    do {                                                                                                                                                                                                                                         \
        char __str[4096];                                                                                                                                                                                                                        \
        switch (P_MOCK->compare_rule_arg[ARGUMENT]) {                                                                                                                                                                                            \
            case COMPARE_STRICT:                                                                                                                                                                                                                 \
                ...
                TEST_ASSERT_EQUAL_##TYPE##_MESSAGE(((STRUCT_TYPE *)P_MOCK->expect_arg[ARGUMENT].p)->MEMBER, ((STRUCT_TYPE *)RECV_POINTER)->MEMBER, __str);                                                                                       \
                break;                                                                                                                                                                                                                           \
            case COMPARE_DELTA:                                                                                                                                                                                                                  \
                sprintf(__str, " as '" TO_STR(MEMBER) "' in argument " #ARGUMENT " in %s(...), mock call expect@%s::%lu. mock_id:%lu", __FUNCTION__, Unity.CurrentTestName, (long unsigned)P_MOCK->line_number, (long unsigned)P_MOCK->mock_id); \
                TEST_ASSERT_##TYPE##_WITHIN_MESSAGE(P_MOCK->delta_arg[ARGUMENT].value, ((STRUCT_TYPE *)P_MOCK->expect_arg[ARGUMENT].p)->MEMBER, ((STRUCT_TYPE *)RECV_POINTER)->MEMBER, __str);                                                   \
                break;                                                                                                                                                                                                                           \
            case COMPARE_NOT_NULL:                                                                                                                                                                                                               \
...
#define MOCK_CALL_COMPARE_STRUCT_ARRAY_UINT8(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH_MEMBER) MOCK_CALL_COMPARE_STRUCT_ARRAY(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH_MEMBER, UINT8)

#define MOCK_CALL_COMPARE_STRUCT_ARRAY_UINT16(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH_MEMBER) MOCK_CALL_COMPARE_STRUCT_ARRAY(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH_MEMBER, UINT16)

#define MOCK_CALL_COMPARE_STRUCT_ARRAY_UINT32(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH_MEMBER) MOCK_CALL_COMPARE_STRUCT_ARRAY(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH_MEMBER, UINT32)

#define MOCK_CALL_COMPARE_STRUCT_ARRAY(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH_MEMBER, TYPE)                                                                                                                                  \
    do {                                                                                                                                                                                                                                                \
        char __str[4096];                                                                                                                                                                                                                               \
        switch (P_MOCK->compare_rule_arg[ARGUMENT]) {                                                                                                                                                                                                   \
            case COMPARE_STRICT:                                                                                                                                                                                                                        \
                ...
                TEST_ASSERT_EQUAL_UINT32_MESSAGE(((STRUCT_TYPE *)P_MOCK->expect_arg[ARGUMENT].p)->LENGTH_MEMBER, ((STRUCT_TYPE *)RECV_POINTER)->LENGTH_MEMBER, __str);                                                                                  \
                ...
                TEST_ASSERT_EQUAL_##TYPE##_ARRAY_MESSAGE(((STRUCT_TYPE *)P_MOCK->expect_arg[ARGUMENT].p)->ARRAY_MEMBER, ((STRUCT_TYPE *)RECV_POINTER)->ARRAY_MEMBER, ((STRUCT_TYPE *)P_MOCK->expect_arg[ARGUMENT].p)->LENGTH_MEMBER, __str);            \
                break;                                                                                                                                                                                                                                  \
            case COMPARE_NOT_NULL:                                                                                                                                                                                                                      \
                sprintf(__str, " Expected Non-NULL in %s(...), mock call expect@%s::%lu. mock_id:%lu", __FUNCTION__, Unity.CurrentTestName, (long unsigned)P_MOCK->line_number, (long unsigned)P_MOCK->mock_id);                                        \
...
#define MOCK_CALL_COMPARE_STRUCT_ARRAY_LENGTH_UINT8(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH) MOCK_CALL_COMPARE_STRUCT_ARRAY_LENGTH(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH, UINT8)

#define MOCK_CALL_COMPARE_STRUCT_ARRAY_LENGTH_UINT16(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH) MOCK_CALL_COMPARE_STRUCT_ARRAY_LENGTH(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH, UINT16)

#define MOCK_CALL_COMPARE_STRUCT_ARRAY_LENGTH_UINT32(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH) MOCK_CALL_COMPARE_STRUCT_ARRAY_LENGTH(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH, UINT32)

#define MOCK_CALL_COMPARE_STRUCT_ARRAY_LENGTH(P_MOCK, ARGUMENT, RECV_POINTER, STRUCT_TYPE, ARRAY_MEMBER, LENGTH, TYPE)                                                                                                                                 \
    do {                                                                                                                                                                                                                                               \
        char __str[4096];                                                                                                                                                                                                                              \
        switch (P_MOCK->compare_rule_arg[ARGUMENT]) {                                                                                                                                                                                                  \
            case COMPARE_STRICT:                                                                                                                                                                                                                       \
                sprintf(__str, " as '" TO_STR(ARRAY_MEMBER) "' in argument " #ARGUMENT " in %s(...), mock call expect@%s::%lu. mock_id:%lu", __FUNCTION__, Unity.CurrentTestName, (long unsigned)P_MOCK->line_number, (long unsigned)P_MOCK->mock_id); \
                TEST_ASSERT_EQUAL_##TYPE##_ARRAY_MESSAGE(((STRUCT_TYPE *)P_MOCK->expect_arg[ARGUMENT].p)->ARRAY_MEMBER, ((STRUCT_TYPE *)RECV_POINTER)->ARRAY_MEMBER, LENGTH, __str);                                                                   \
                break;                                                                                                                                                                                                                                 \
            case COMPARE_NOT_NULL:                                                                                                                                                                                                                     \
...
#define MOCK_CALL_COMPARE_INPUT_UINT8_ARRAY(P_MOCK, ARGUMENT, EXPECT_LENGTH, P_RECV_ARRAY, RECV_LENGTH) MOCK_CALL_COMPARE_INPUT_ARRAY(P_MOCK, ARGUMENT, EXPECT_LENGTH, P_RECV_ARRAY, RECV_LENGTH, UINT8)

#define MOCK_CALL_COMPARE_INPUT_UINT16_ARRAY(P_MOCK, ARGUMENT, EXPECT_LENGTH, P_RECV_ARRAY, RECV_LENGTH) MOCK_CALL_COMPARE_INPUT_ARRAY(P_MOCK, ARGUMENT, EXPECT_LENGTH, P_RECV_ARRAY, RECV_LENGTH, UINT16)

#define MOCK_CALL_COMPARE_INPUT_UINT32_ARRAY(P_MOCK, ARGUMENT, EXPECT_LENGTH, P_RECV_ARRAY, RECV_LENGTH) MOCK_CALL_COMPARE_INPUT_ARRAY(P_MOCK, ARGUMENT, EXPECT_LENGTH, P_RECV_ARRAY, RECV_LENGTH, UINT32)

#define MOCK_CALL_COMPARE_INPUT_INT_ARRAY(P_MOCK, ARGUMENT, EXPECT_LENGTH, P_RECV_ARRAY, RECV_LENGTH) MOCK_CALL_COMPARE_INPUT_ARRAY(P_MOCK, ARGUMENT, EXPECT_LENGTH, P_RECV_ARRAY, RECV_LENGTH, INT)

#define MOCK_CALL_COMPARE_INPUT_ARRAY(P_MOCK, ARGUMENT, EXPECT_LENGTH, P_RECV_ARRAY, RECV_LENGTH, TYPE)                                                                                                                                       \
    do {                                                                                                                                                                                                                                      \
        char __str[4096];                                                                                                                                                                                                                     \
        switch (P_MOCK->compare_rule_arg[ARGUMENT]) {                                                                                                                                                                                         \
            case COMPARE_STRICT:                                                                                                                                                                                                              \
...
#define MOCK_CALL_SET_OUTPUT_ARRAY(P_RESULT_ARRAY, P_OUT_ARRAY, LENGTH, TYPE) \
    do {                                                                      \
        uint32_t __loop_i;                                                    \
...
#define MOCK_CALL_COMPARE_INPUT_POINTER(P_MOCK, ARGUMENT, P_RECV_VALUE)                                                                                                                                                                     \
    do {                                                                                                                                                                                                                                    \
        char __str[4096];                                                                                                                                                                                                                   \
        switch (P_MOCK->compare_rule_arg[ARGUMENT]) {                                                                                                                                                                                       \
            case COMPARE_STRICT:                                                                                                                                                                                                            \
...
#define MOCK_CALL_FIND_RETURN_ON_FAILURE(P_MOCK, DEFAULT_VAL) \
    do {                                                      \
...
#define MOCK_CALL_FIND_RETURN_VOID_ON_FAILURE(P_MOCK) \
    do {                                              \
        if (!mock_call_find(__FUNCTION__, &P_MOCK)) { \
            return;                                   \
        }                                             \
...
#define MOCK_CALL_RETURN_IF_USED_AS_STUB(DEFAULT_VAL)                  \
    do {                                                               \
...
#define MOCK_CALL_RETURN_VOID_IF_USED_AS_STUB()                        \
    do {                                                               \
        if (mock_call_used_as_stub(MOCK_FILE, __FUNCTION__) == true) { \
            return;                                                    \
        }                                                              \
...
#define MOCK_CALL_RETURN_FAKE_ARG1(P_FUNCTION, ARG0)                   \
    do {                                                               \
...
#define MOCK_CALL_RETURN_FAKE_ARG2(P_FUNCTION, ARG0, ARG1)             \
    do {                                                               \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) { \
...
#define MOCK_CALL_RETURN_FAKE_ARG3(P_FUNCTION, ARG0, ARG1, ARG2)       \
    do {                                                               \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) { \
...
#define MOCK_CALL_RETURN_FAKE_ARG4(P_FUNCTION, ARG0, ARG1, ARG2, ARG3) \
    do {                                                               \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) { \
...
#define MOCK_CALL_RETURN_FAKE_ARG5(P_FUNCTION, ARG0, ARG1, ARG2, ARG3, ARG4) \
    do {                                                                     \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {       \
...
#define MOCK_CALL_RETURN_FAKE_ARG6(P_FUNCTION, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5) \
    do {                                                                           \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {             \
...
#define MOCK_CALL_RETURN_FAKE_ARG7(P_FUNCTION, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6) \
    do {                                                                                 \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {                   \
...
#define MOCK_CALL_RETURN_FAKE_ARG8(P_FUNCTION, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7) \
    do {                                                                                       \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {                         \
...
#define MOCK_CALL_RETURN_FAKE_ARG9(P_FUNCTION, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8) \
    do {                                                                                             \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {                               \
...
#define MOCK_CALL_RETURN_VOID_FAKE_ARG1(P_FUNCTION, ARG0)              \
    do {                                                               \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) { \
            P_FUNCTION(ARG0);                                          \
            return;                                                    \
...
#define MOCK_CALL_RETURN_VOID_FAKE_ARG2(P_FUNCTION, ARG0, ARG1)        \
    do {                                                               \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) { \
...
#define MOCK_CALL_RETURN_VOID_FAKE_ARG3(P_FUNCTION, ARG0, ARG1, ARG2)  \
    do {                                                               \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) { \
...
#define MOCK_CALL_RETURN_VOID_FAKE_ARG4(P_FUNCTION, ARG0, ARG1, ARG2, ARG3) \
    do {                                                                    \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {      \
...
#define MOCK_CALL_RETURN_VOID_FAKE_ARG5(P_FUNCTION, ARG0, ARG1, ARG2, ARG3, ARG4) \
    do {                                                                          \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {            \
...
#define MOCK_CALL_RETURN_VOID_FAKE_ARG6(P_FUNCTION, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5) \
    do {                                                                                \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {                  \
...
#define MOCK_CALL_RETURN_VOID_FAKE_ARG7(P_FUNCTION, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6) \
    do {                                                                                      \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {                        \
...
#define MOCK_CALL_RETURN_VOID_FAKE_ARG8(P_FUNCTION, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7) \
    do {                                                                                            \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {                              \
...
#define MOCK_CALL_RETURN_VOID_FAKE_ARG9(P_FUNCTION, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8) \
    do {                                                                                                  \
        if (mock_call_used_as_fake(MOCK_FILE, __FUNCTION__) == true) {                                    \
...
#define MOCK_CALL_RETURN_IF_ERROR_SET(P_MOCK, TYPE) \
    do {                                            \
...
#define MOCK_CALL_RETURN_VALUE(P_MOCK, TYPE)    \
    do {                                        \
        return (TYPE)P_MOCK->return_code.value; \
    } while (0)

#define MOCK_CALL_RETURN_POINTER(P_MOCK, TYPE)    \
    do {                                          \
        return (TYPE)P_MOCK->return_code.pointer; \
    } while (0)

#define MOCK_CALL_ACTUAL_ARG1(P_MOCK, ARG0)                      \
    do {                                                         \
        P_MOCK->actual_arg[0].pointer = (void *)(uintptr_t)ARG0; \
    } while (0)

#define MOCK_CALL_ACTUAL_ARG2(P_MOCK, ARG0, ARG1)                \
    do {                                                         \
        P_MOCK->actual_arg[0].pointer = (void *)(uintptr_t)ARG0; \
        P_MOCK->actual_arg[1].pointer = (void *)(uintptr_t)ARG1; \
    } while (0)

#define MOCK_CALL_ACTUAL_ARG3(P_MOCK, ARG0, ARG1, ARG2)          \
    do {                                                         \
        P_MOCK->actual_arg[0].pointer = (void *)(uintptr_t)ARG0; \
        P_MOCK->actual_arg[1].pointer = (void *)(uintptr_t)ARG1; \
...
#define MOCK_CALL_ACTUAL_ARG4(P_MOCK, ARG0, ARG1, ARG2, ARG3)    \
    do {                                                         \
        P_MOCK->actual_arg[0].pointer = (void *)(uintptr_t)ARG0; \
        P_MOCK->actual_arg[1].pointer = (void *)(uintptr_t)ARG1; \
        P_MOCK->actual_arg[2].pointer = (void *)(uintptr_t)ARG2; \
...
#define MOCK_CALL_ACTUAL_ARG5(P_MOCK, ARG0, ARG1, ARG2, ARG3, ARG4) \
    do {                                                            \
        P_MOCK->actual_arg[0].pointer = (void *)(uintptr_t)ARG0;    \
        P_MOCK->actual_arg[1].pointer = (void *)(uintptr_t)ARG1;    \
        P_MOCK->actual_arg[2].pointer = (void *)(uintptr_t)ARG2;    \
...
#define MOCK_CALL_ACTUAL_ARG6(P_MOCK, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5) \
    do {                                                                  \
        P_MOCK->actual_arg[0].pointer = (void *)(uintptr_t)ARG0;          \
        P_MOCK->actual_arg[1].pointer = (void *)(uintptr_t)ARG1;          \
        P_MOCK->actual_arg[2].pointer = (void *)(uintptr_t)ARG2;          \
...
#define MOCK_CALL_ACTUAL_ARG7(P_MOCK, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6) \
    do {                                                                        \
        P_MOCK->actual_arg[0].pointer = (void *)(uintptr_t)ARG0;                \
        P_MOCK->actual_arg[1].pointer = (void *)(uintptr_t)ARG1;                \
        P_MOCK->actual_arg[2].pointer = (void *)(uintptr_t)ARG2;                \
...
#define MOCK_CALL_ACTUAL_ARG8(P_MOCK, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7) \
    do {                                                                              \
        P_MOCK->actual_arg[0].pointer = (void *)(uintptr_t)ARG0;                      \
        P_MOCK->actual_arg[1].pointer = (void *)(uintptr_t)ARG1;                      \
        P_MOCK->actual_arg[2].pointer = (void *)(uintptr_t)ARG2;                      \
...
#define MOCK_CALL_ACTUAL_ARG9(P_MOCK, ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8) \
    do {                                                                                    \
        P_MOCK->actual_arg[0].pointer = (void *)(uintptr_t)ARG0;                            \
        P_MOCK->actual_arg[1].pointer = (void *)(uintptr_t)ARG1;                            \
        P_MOCK->actual_arg[2].pointer = (void *)(uintptr_t)ARG2;                            \
