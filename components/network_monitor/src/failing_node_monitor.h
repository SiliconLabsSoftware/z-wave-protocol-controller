...
// Time intervals in seconds (stored as uint32_t seconds)
// Start interval for pinging AL nodes
#define AL_NODE_PING_TIME_INTERVAL 4  // 4 seconds
// Multication factor for AL nodes intervals
#define AL_NODE_PING_TIME_FACTOR 2

// Start interval for pinging FL nodes
#define FL_NODE_PING_TIME_INTERVAL 40  // 40 seconds
...
#define MAX_PING_TIME_INTERVAL (24 * 60 * 60)  // 24 hours in seconds
