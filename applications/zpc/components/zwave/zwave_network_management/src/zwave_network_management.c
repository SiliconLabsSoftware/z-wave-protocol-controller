...
zwave_network_management_set_priority_route(zwave_node_id_t node_id,
  ...
  memcpy(priority_route_event_data.route, priority_route,
         sizeof(priority_route_event_data.route));

  process_post(&zwave_network_management_process, NM_EV_SET_PRIORITY_ROUTE,
