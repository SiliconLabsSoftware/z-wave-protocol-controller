...
typedef struct zwave_tx_options {
        ...
        /// When true, S2 will not enter VERIFYING_DELIVERY for this frame.
        /// Use for frames that are part of a higher-level pull protocol where
        /// delivery is confirmed by the peer's next request (e.g. OTA chunks).
        bool skip_s2_verify_delivery;
