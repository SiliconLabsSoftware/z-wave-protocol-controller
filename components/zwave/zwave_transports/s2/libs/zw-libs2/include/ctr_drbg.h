...
DllExport void AES_CTR_DRBG_Reseed(CTR_DRBG_CTX *ctx, uint8_t *seed);
 ...
 */
DllExport void AES_CTR_DRBG_Instantiate(CTR_DRBG_CTX *ctx, uint8_t *entropy_input, const uint8_t *personalization);
 ...
 */
DllExport void AES_CTR_DRBG_Generate(CTR_DRBG_CTX *ctx, uint8_t *rand);
