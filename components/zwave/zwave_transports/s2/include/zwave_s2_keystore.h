...
/**
 * @brief Collect the currently-assigned Z-Wave Security Keys into a
 *        caller-provided buffer as a YAML map.
 *
 * @param[out] buf      Destination buffer.
 * @param[in]  buf_cap  Capacity of the destination buffer in bytes.
 * @param[out] out_len  Number of bytes written to the destination buffer.
 *
 * @return SL_STATUS_OK on success.
 * @return SL_STATUS_NULL_POINTER if buf or out_len is NULL.
 * @return SL_STATUS_WOULD_OVERFLOW if buf_cap is too small to hold the output.
 */
