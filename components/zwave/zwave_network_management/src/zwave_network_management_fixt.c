...
{
    sl_status_t ret = zwave_controller_register_reset_step(&zwave_network_management_set_default, ZWAVE_CONTROLLER_ZWAVE_NETWORK_MANAGEMENT_RESET_STEP_PRIORITY);
