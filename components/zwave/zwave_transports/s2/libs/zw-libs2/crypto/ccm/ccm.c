...
static int format_b0(const uint8_t t, const uint16_t text_to_encrypt_len, uint8_t *first_block, const uint8_t *nonce)
{
    uint8_t i;
...
static void format_payload_block(uint8_t blocks[2][BLOCK_SIZE], const uint8_t *P, const uint16_t text_to_encrypt_len, const uint8_t *key)
{
    int i;
...
static void encrypt_or_decrypt(uint8_t *data_array, uint16_t data_len, uint16_t num_ctr_blks, uint8_t *block, const uint8_t *nonce, int mac_len, const uint8_t *key, uint8_t *mac, int mode)
...
uint32_t CCM_encrypt_and_auth(const uint8_t *key, const uint8_t *nonce, const uint8_t *aad, const uint32_t aad_len, uint8_t *plain_ciphertext, const uint16_t text_to_encrypt_len)
{
...
uint16_t CCM_decrypt_and_auth(const uint8_t *key, const uint8_t *nonce, const uint8_t *aad, const uint32_t aad_len, uint8_t *cipher_plaintext, const uint32_t ciphertext_len)
{
    uint8_t blocks[2][BLOCK_SIZE];
