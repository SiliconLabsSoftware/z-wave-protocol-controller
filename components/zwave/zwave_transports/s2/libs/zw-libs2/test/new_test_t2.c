...
unsigned char test_first_frag1[] = {0x55,  // COMMAND_CLASS_TRANSPORT_SERVICE_V2
...
unsigned char test_subseq_frag2[] = {0x55,  // COMMAND_CLASS_TRANSPORT_SERVICE_V2
...
unsigned char test_subseq_frag2a[] = {0x55,  // COMMAND_CLASS_TRANSPORT_SERVICE_V2
                                      0xe0,  // COMMAND_SUBSEQUENT_FRAGMENT[7..3], datagram_size_1[2..0] (size bits 10..8 = 0)
                                      0x6a,  // datagram_size_2 (size bits 7..0 = 106)
                                      0x00,  // session_ID [7..4], Ext[3] (=0 i.e. no ext header), datagram_offset_1[2..0] (size bits 10..8 = 0)
                                      0x2f,  // datagram_offset_2 (size bits 7..0 = 47)
...
unsigned char test_subseq_frag2b[] = {0x55,  // COMMAND_CLASS_TRANSPORT_SERVICE_V2
                                      0xe0,  // COMMAND_SUBSEQUENT_FRAGMENT[7..3], datagram_size_1[2..0] (size bits 10..8 = 0)
                                      0x6a,  // datagram_size_2 (size bits 7..0 = 106)
                                      0x00,  // session_ID [7..4], Ext[3] (=0 i.e. no ext header), datagram_offset_1[2..0] (size bits 10..8 = 0)
...
unsigned char test_subseq_frag3[] = {0x55,  // COMMAND_CLASS_TRANSPORT_SERVICE_V2
                                     0xe0,  // COMMAND_SUBSEQUENT_FRAGMENT[7..3], datagram_size_1[2..0] (size bits 10..8 = 0)
                                     0x6a,  // datagram_size_2 (size bits 7..0 = 106)
                                     0x00,  // session_ID [7..4], Ext[3] (=0 i.e. no ext header), datagram_offset_1[2..0] (size bits 10..8 = 0)
...
unsigned char raw_data[]  = {0x20, 0x01, 0x00, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A,
                             0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B, 0x2C, 0x2D, 0x2E, 0x2F, 0x30, 0x31, 0x32, 0x33, 0x34};
unsigned char raw_data2[] = {0x20, 0x01, 0x00, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23,
                             0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B, 0x2C, 0x2D, 0x2E, 0x2F, 0x30, 0x31, 0x32, 0x33, 0x34, 0x20, 0x01, 0x00, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12,
                             0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B, 0x2C, 0x2D, 0x2E, 0x2F, 0x30, 0x31, 0x32, 0x33, 0x34};
