 ...
 */
extern zw_status_t zw_compute_ecdh_shared_secret(
  const uint8_t *remote_public_key, uint32_t keyid, uint8_t *result);

extern zw_status_t
  zw_compute_inclusion_ecdh_shared_secret(const uint8_t *remote_public_key,
                                          uint8_t *result);
 ...
 */
extern zw_status_t zw_wrap_aes_key_secure_vault(uint32_t *key_id,
 ...
 */
extern zw_status_t zw_read_vault_network_key_aes_cmac(uint32_t key_id,
                                                      uint8_t *buff,
                                                      size_t buff_size,
                                                      size_t *out_len);
 ...
 */
extern zw_status_t zw_psa_aes_cmac(uint32_t key_id,
                                   const uint8_t *input,
                                   size_t length,
                                   uint8_t *output);
 ...
 */
extern zw_status_t zw_psa_aead_encrypt_ccm(uint32_t key_id,
                                           const uint8_t *nonce,
                                           size_t nonce_len,
                                           const uint8_t *ad,
                                           size_t ad_len,
 ...
 */
extern zw_status_t zw_psa_aead_decrypt_ccm(uint32_t key_id,
                                           const uint8_t *nonce,
                                           size_t nonce_len,
                                           const uint8_t *ad,
                                           size_t ad_len,
 ...
 */
extern zw_status_t zw_psa_aes_ecb_encrypt(uint32_t key_id,
                                          const uint8_t *input,
                                          uint8_t *output);
 ...
 */
extern zw_status_t zw_wrap_aes_key_secure_vault_test(uint32_t *key_id,
                                                     const uint8_t *aes_key,
                                                     uint32_t key_algorithm);
...
extern uint32_t
  convert_keyclass_to_derived_key_id(uint32_t key_class,
                                     zwave_derived_key_type_t key_type);
