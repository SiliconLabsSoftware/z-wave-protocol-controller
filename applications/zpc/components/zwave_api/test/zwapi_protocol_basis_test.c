...
{
  //Happy case
  zwapi_support_command_func_ExpectAndReturn(FUNC_ID_ZW_TRANSFER_PROTOCOL_CC,
                                             true);
  zwapi_support_command_func_ExpectAndReturn(FUNC_ID_ZW_ENABLE_NODE_NLS, true);
  zwapi_support_command_func_ExpectAndReturn(FUNC_ID_ZW_GET_NODE_NLS_STATE,
                                             true);
  zwapi_support_command_func_ExpectAndReturn(
    FUNC_ID_ZW_REQUEST_PROTOCOL_CC_ENCRYPTION,
    true);
  zwapi_support_command_func_ExpectAndReturn(FUNC_ID_ZW_SEND_PROTOCOL_DATA,
                                             true);
