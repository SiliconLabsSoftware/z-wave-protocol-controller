...
/**
 * @brief Post an event to the network management handler thread.
 * @param ev   Event to post (must be < NM_EV_MAX).
 * @param data Optional event data pointer (may be NULL).
 */
