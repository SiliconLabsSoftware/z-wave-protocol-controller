...
typedef enum { SPAN_NOT_USED, SPAN_NO_SEQ, SPAN_SOS, SPAN_SOS_LOCAL_NONCE, SPAN_SOS_REMOTE_NONCE, SPAN_INSTANTIATE, SPAN_NEGOTIATED } span_state_t;
...
struct S2 {
        ...
        uint8_t kex_report_echo_payload[4];  // Raw KEX Report payload (bytes 2-5) for exact echo per CC:009F.01.05.11.005.
