...
#[cfg(target_os = "windows")]
lazy_static! { static ref SILINK_PATH: PathBuf = PathBuf::from(r#".\resources\commander\silink.exe"#); }
#[cfg(target_os = "linux")]
lazy_static! { static ref SILINK_PATH: PathBuf = PathBuf::from(r#"./resources/commander/silink"#); }
#[cfg(target_os = "macos")]
lazy_static! { static ref SILINK_PATH: PathBuf = PathBuf::from(r#"./resources/commander/Contents/MacOS/silink"#); }
...
#[cfg(target_os = "macos")]
lazy_static! { static ref COMMANDER_PATH: PathBuf = PathBuf::from(r#"./resources/commander/Contents/MacOS/commander"#); }
...
pub fn set_eed_device_type_arg(arg_str: &str) {
    set_env_var("EED_DEVICE_TYPE_ARG", arg_str);
}
...
pub static PROTCOL_MODULE_LIST:[&str; 1] = ["Z-Wave"];
...
pub fn docker_compose_up(service_list: &str) -> Result<ExitStatus, std::io::Error> {
    ...
    if service_list != "" {
        ...
        up_list.extend(["unify-eed", "unify-nal", "unify-gms", "unify-upvl", "unify-image-provider"]);
    }
